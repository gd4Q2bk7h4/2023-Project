...
def handle_client_connection(client_socket,addr):
    ...
    while True:
        ...
        # Command timeout
        if not request:
            timeout_start(laser_name=laser_record[0],laser_channel=laser_record[1],powermeter_name=powermeter_record[0],powermeter_channel=powermeter_record[1],laser_dictionary=laser,powermeter_dictionary=powermeter)
            break
