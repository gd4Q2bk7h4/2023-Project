...
class laser(object):
    ...
    class OSICSLaser(object):
        ...
        def __init__(self, socket,channel_number=1):
            ...
            if r == f'OSICS: CH [{channel_number}] is a valid device': #match with record':
        ...
        def disable_channel(self): 
            ...
            if r == f'CH{self.channel_number}:OK':
                print(f'OSICS CH:{self.channel_number} is DISABLED')
        ...
        def enable_channel(self): 
            ...
            r = recv(s=self.socket)
            if r == f'CH{self.channel_number}:OK':
                print(f'OSICS CH:{self.channel_number} is ENABLED')
        ...
        def query_wavelength(self):
            ...
            print(f'OSICS CH:{self.channel_number} is set to {wavelength} nm')
        ...
        def query_frequency(self):
            ...
            r = recv(s=self.socket)
            frequency = r.split('=')[1]
            print(f'OSICS CH:{self.channel_number} is set to {frequency} GHZ')
