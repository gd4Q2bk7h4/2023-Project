...
class laser(object):
    ...
    class OSICSLaser(object):
        ...
        def query_channel_spectral_unit(self,channel_number=1):
            ...
            response =  r.split(':')[1]
            if response == '0':
                print(f'The channel {channel_number} query spectral unit is GHZ')
            elif response == '1':
                print(f'The channel {channel_number} query spectral unit is nm')
        ...
        def query_channel_power_unit(self,channel_number=1):
            ...
            response = r.split(':')[1]
            if response == '0':
                print(f'The channel {channel_number} query power unit is dBm')
            elif response == '1':
                print(f'The channel {channel_number} query power unit ismW')
        ...
        def query_output_power(self,channel_number=1):
            ...
            if response == 'Disabled':
                print(f'The output power of channel {channel_number} is {response}')
            else:
                print(f'The output power of channel {channel_number} is {response}{unit}')
        ...
        def query_current(self,channel_number=1):
            ...
            if r[-8:0] == 'Disabled':
                ...
                print(f'The optical output of channel {channel_number} is {value}mA')
        ...
        def query_current_max(self,channel_number=1):
            ...
            r = recv(s=self.socket)
            value = r.split('=')[1]
            print(f'The diode maximum current of channel {channel_number} is {value}')
        ...
        def query_wavelength(self,channel_number=1):
            ...
            r = recv(s=self.socket)
            value = r.split('=')[1]
            print(f'The emission wavelength of channel {channel_number} is {value}nm')
